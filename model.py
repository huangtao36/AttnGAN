...
class INIT_STAGE_G(nn.Module):
    ...
    def forward(self, z_code, c_code):
        ...
        out_code = F.interpolate(out_code, scale_factor=2, mode='nearest')
        ...
        out_code64 = F.interpolate(out_code32, scale_factor=2, mode='nearest')
        out_code64 = self.upsample4(out_code64)
